  ...
  private Collection<MavenExecutionResult> doResolveProject(@NotNull final Collection<File> files,
    ...
    executeWithMavenSession(request, (Runnable)() -> {
      try {
        ...
        final Map<MavenProject, List<ModelProblem>> values = new LinkedHashMap<>(files.size());
        ...
        for (final Map.Entry<MavenProject, List<ModelProblem>> value : values.entrySet()) {
          ...
          if (USE_MVN2_COMPATIBLE_DEPENDENCY_RESOLVING) {
            ...
            final List<ModelProblem> modelProblems = value.getValue();
