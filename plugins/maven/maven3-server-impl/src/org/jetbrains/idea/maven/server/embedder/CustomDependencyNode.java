...
class CustomDependencyNode implements DependencyNode {
  ...
  public List<DependencyNode> getChildren() {
    final List<DependencyNode> children = myDelegate.getChildren();
    final List<DependencyNode> wrapperChildren = new ArrayList<>(children.size());

    for (final DependencyNode child : children) {
      wrapperChildren.add(new CustomDependencyNode(child));
    }
